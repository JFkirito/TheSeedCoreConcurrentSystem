...
from TheSeedCoreConcurrentSystem import ConcurrentSystem, ConnectConcurrentSystem, QApplication, TaskFuture
...
class View(QWidget):
    ...
    def _start_batch_test(self):
        ...
        ConcurrentSystem.submitSystemThreadTask(ConcurrentSystem.submitProcessTask, 100, self.process_test_function, callback=self.process_test_callback, start_time=start_time)
        ConcurrentSystem.submitSystemThreadTask(ConcurrentSystem.submitThreadTask, 100, self.process_test_function, callback=self.thread_test_callback, start_time=start_time)
